cd bare_c_code/riscv32_C_interrupt/
...
cp bare_c_code/riscv32_C_interrupt/compilation.log                      rtl/riscv32i_module/assembly_code/compilation.log            
cp bare_c_code/riscv32_C_interrupt/compilation/instrictions.log         rtl/riscv32i_module/assembly_code/instrictions.log 
cp bare_c_code/riscv32_C_interrupt/compilation/program.hex              rtl/riscv32i_module/assembly_code/program.hex 
cp bare_c_code/riscv32_C_interrupt/compilation/program.c                rtl/riscv32i_module/assembly_code/program.c 
cp bare_c_code/riscv32_C_interrupt/compilation/program_disassembly.txt  rtl/riscv32i_module/assembly_code/program_disassembly.txt
cp bare_c_code/riscv32_C_interrupt/compilation/program.hex              rtl/riscv32i_module/program.hex 
